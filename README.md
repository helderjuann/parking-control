...
To do: *Lógica para o cálculo de preço e emissão de ticket - Fazer botão scroll up* - 31/10/23 <br> Atualizações frequentes para melhorar o funcionamento client side <br><br>
